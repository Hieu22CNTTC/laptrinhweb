...
<html>
<head>
    <title>Chỉnh Sửa Khoản Phí</title>
...
<body>
    ...
    <div class="main-content">
        <h1 class="text-center">Chỉnh Sửa Khoản Phí</h1>
        <div class="form-container">
            <form action="fee?action=update" method="post" accept-charset="UTF-8">
                <!-- ID Khoản Phí -->
                    ...
                    <select id="semesterId" name="semesterId" class="form-control" required>
                        <c:forEach var="semester" items="${semesterList}">
                            <option value="${semester.semesterId}" 
                                <c:if test="${semester.semesterId == fee.semesterId}">selected</c:if>>
